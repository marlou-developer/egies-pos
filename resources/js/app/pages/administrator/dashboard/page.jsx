                ...
                <div>
                    ...
                    {/* <div className="flex gap-6 mb-3">
                        ...
                        <DashboardCardSections
                            ...
                            count={<>{formatValue(dashboard?.total_cost)}</>}
                        />
                        <DashboardCardSections
                            title="Total Profit"
                            icon={
                ...
                <div>
                    ...
                    <div className="flex gap-6 mb-3">
                        <DashboardCardSections
                            ...
                            icon={
                                <CreditCardIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>{formatValue(dashboard?.current_credit)}</>
                            }
                        />
                        <DashboardCardSections
                        ...
                        <DashboardCardSections
                            ...
                            icon={
                                <CalendarDaysIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>
                                    {formatValue(
                                        dashboard?.due_date_today,
                                        false
                                    )}
                                </>
                            }
                        ...
                        <DashboardCardSections
                            ...
                            icon={
                                <CalendarIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>{formatValue(dashboard?.over_due, false)}</>
                            }
                        />
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex gap-6 mb-3">
                        <DashboardCardSections
                            ...
                            icon={
                                <ExclamationCircleIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>{formatValue(dashboard?.low_stock, false)}</>
                            }
                        />
                        <DashboardCardSections
                            title="No. Of Out of Stock Product"
                            icon={
                                <NoSymbolIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>
                                    {formatValue(
                        ...
                        <DashboardCardSections
                            ...
                            icon={
                                <BanknotesIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>
                                    {formatValue(
                                        dashboard?.total_overall_inventory_retail_price
                                    )}
                                </>
                            }
                        />
                        <DashboardCardSections
                            ...
                            icon={
                                <CircleStackIcon className="h-14 text-pink-600" />
                            }
                            count={
                                <>
                                    {formatValue(
                                        dashboard?.total_overall_inventory_capital
                                    )}
                                </>
                            }
                        />
                    ...
                    <div className="flex gap-6 mb-3">
                        <DashboardCardSections
                            ...
                            icon={
                                <FontAwesomeIcon
                                    icon={faPesetaSign}
                                    className="h-11 text-pink-600"
                                />
                            }
                            count={
                                <>{formatValue(dashboard?.current_expenses)}</>
                            }
                        />
                        {/* <DashboardCardSections
                            title="No. Of Out of Stock Product"
                        ...
                        <DashboardCardSections
                            ...
                            count={
                                <>{formatValue(dashboard?.total_expenses)}</>
                            }
                        />
                    </div>
                </div>
