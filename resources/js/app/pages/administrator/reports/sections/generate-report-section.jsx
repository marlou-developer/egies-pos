...
export default function GenerateReportSection() {
    ...
    const handleGenerate = () => {
        router.visit(`/administrator/reports?start=${form.dateRange[0]}&end=${form.dateRange[1]}&type=${form.type}`);
    };
    return (
        <div className='mb-4'>
            ...
            <div className='flex gap-3 w-full'>
                ...
                <div className='flex-1'>
                    <select
                        ...
                        <option value="" disabled>Select Report to Generate</option>
                        ...
                        <option value="Sales By Payment Types">Sales By Payment Types</option>
                        <option value="Unpaid Sales">Unpaid Sales</option>
                        <option value="Purchase by Product">Purchase by Product</option>
                        <option value="Payment Types by User">Payment Types by User</option>
                        <option value="Purchase by Supplier">Purchase by Supplier</option>
                        <option value="Payment Types by Customer">Payment Types by Customer</option>
