...
const PurchaseBySupplierReportSection = () => {
            ...
            <Document>
                <Page size="A4" style={styles.page}>
                    <View style={styles.header}>
                        <Text style={styles.title}>PURCHASE BY SUPPLIER</Text>
                    ...
                    <View style={styles.tableHeader}>
                        <Text style={styles.colSmall}>Supplier</Text>
                        <Text style={styles.col}>Total Before Tax</Text>
...
export default PurchaseBySupplierReportSection;
