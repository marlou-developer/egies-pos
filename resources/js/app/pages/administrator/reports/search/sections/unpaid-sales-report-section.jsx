...
const UnpaidSalesReportSection = () => {
    ...
    const overall_total = reports?.data?.reduce((sum, item) => {
        const cart = item.carts?.[0];
        return sum + (cart ? Number(cart.balance) : 0);
    }, 0);
    return (
                    ...
                    <View>
                        ...
                        >
                            <Text style={{ fontWeight: "bold" }}>
                                Overall Total: {peso_value(overall_total)}
                            </Text>
                        </View>
                    </View>
                </Page>
