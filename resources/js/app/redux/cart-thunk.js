import {
    ...
    delete_cart_service,
    delete_credit_payment_service,
    get_cart_by_id_service,
    get_cart_service,
    get_over_due_service,
    get_report_items_service,
    get_report_service,
    get_sales_service,
    get_shopee_service,
    update_cart_service,
...
} from "../pages/services/cart-service";
...
export function delete_credit_payment_thunk(id) {
    return async function (dispatch, getState) {
        const res = await delete_credit_payment_service(id);
    };
}
