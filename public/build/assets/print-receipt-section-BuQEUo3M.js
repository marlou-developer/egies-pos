import{r as d,j as e}from"./app-B2nzJY5f.js";import{p as n}from"./peso-BbTyboS3.js";import{h as l}from"./moment-C5S46NFB.js";function j({id:o,onPrinted:a,data:s,reset1:c,reset2:m,productId:h}){const r=d.useRef();return d.useEffect(()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const i=t.contentWindow.document;i.open(),i.write(`
            <html>
                <head>
