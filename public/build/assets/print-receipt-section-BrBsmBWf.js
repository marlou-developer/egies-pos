import{r as l,j as e}from"./app-DVbbTlFN.js";import{p as n}from"./peso-BbTyboS3.js";function h({onPrinted:c,data:t,reset1:d,reset2:o,productId:a}){const r=l.useRef();return l.useEffect(()=>{const s=document.createElement("iframe");s.style.position="fixed",s.style.right="0",s.style.bottom="0",s.style.width="0",s.style.height="0",s.style.border="0",document.body.appendChild(s);const i=s.contentWindow.document;i.open(),i.write(`
            <html>
                <head>
